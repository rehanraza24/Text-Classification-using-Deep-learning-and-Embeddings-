...
In Notebook [Sarcasm Detection](https://github.com/rehanraza24/Text-Classification-using-Deep-learning-and-Embeddings-/blob/main/Sarcasm%20Detection.ipynb) it is very short version where i have just built Keras models and i made accuracy loss graphs.
There are notebooks with model building BUT main part is Text preprocessing which is very important. <br>
### You can see this detailed [Text Preprocessing Notebook](https://github.com/rehanraza24/Twitter-Text-Sentiment-Analysis-) with Spacy,Gensim, Textblob and more about pretrained-Embedding Vectors where we visualise Similarity and using these we can imporve our models.
